...
export const updateSessionIntent = createAction('[Session] Update intent', props<{taskId: string, sessionId: string}>())
export const updateSession = createAction('[Session] Update', props<{taskId: string, sessionId: string, start: number, end: Session['end']}>())
export const moveSessionToTaskIntent = createAction('[Session] Move to task intent', props<{taskId: string, sessionId: string}>())
